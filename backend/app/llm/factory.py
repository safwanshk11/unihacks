...
from app.llm.lighting_provider import LightingEnrichmentProvider
...
# - "lighting": pure deterministic pipeline, no LLM calls at all. Useful for
#   comparing against the hybrid output, or running with Ollama uninstalled.
...
_PROVIDERS: dict[str, type[EnrichmentProvider]] = {
    ...
    "lighting": LightingEnrichmentProvider,
}
